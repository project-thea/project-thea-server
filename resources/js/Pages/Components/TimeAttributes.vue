<template>
    ...
    <jet-input type="text" @change="handleDefaultChange" placeholder="Enter time based on the format selected e.g 14:00 or 2:00pm" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="exampleFormControlInput1" />
