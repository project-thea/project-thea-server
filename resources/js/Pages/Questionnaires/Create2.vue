                ...
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-4">
                    ...
                    <form @submit.prevent="createQuestionnaire">
                        ...
                        <div class="mt-2">
                            ...
                            <select name="project_id" v-model="form.project_id" class="mt-1 block w-full border-gray-300 focus:border-indigo-300 focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow sm">
